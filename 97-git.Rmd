...
- The easiest way to avoid conflicts is to help other always be in
  sync with the remote repository. To do so, regularly push your
  changes to the remote, so that others can pull them.
