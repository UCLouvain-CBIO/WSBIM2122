...
drive and/or send updates by email. Such a situaton may lead to a well
...
analysis or software project. In addition, a version control is
...
elsewhere, on another user's computer, or a server; such a repositories
are called a *remote* repositories.
...
At the time of cloning, the content of the local and remote repositories
are identical.
...
- Alice and Bastien pull the latest changes and modify the empty `file1`
...
little annoying hickup are conflicts. It is best to avoid these by
