...
coefficients are computed. They give estimates of the log fold changes[^logFC_shrinkage] for gene i
for each column of the model matrix. Standard errors for the log2 fold changes are
also estimated.

[^logFC_shrinkage]: DESeq2 offers further options to shrink LFC estimates. This is useful for ranking and visualization (see [DESeq2 vignette](https://bioconductor.org/packages/release/bioc/vignettes/DESeq2/inst/doc/DESeq2.html) for more information).
