...
a bioconductor package dedicated to this type of analysis which is very frequently used. For more 
information read the original paper [@Huber:2014] and the [DESeq2 vignette](https://bioconductor.org/packages/release/bioc/vignettes/DESeq2/inst/doc/DESeq2.html).
