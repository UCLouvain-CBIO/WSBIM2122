...
The starting point of the analysis is the count matrix, and the goal is to identify 
...
DESeq2 will normalise the raw counts to account for differences in library depth and 
...
As illustrated below, Gene 1 and Gene 2 have similar levels of expression, 
but many more reads map to Gene 2 than to Gene 1. This is not related to biology 
but it is just because Gene 2 is longer. Gene length normalisation is mandatory 
when the purpuse is to compare expression levels between different genes within 
