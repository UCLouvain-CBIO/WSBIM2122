...
DESeq2 fits a generalized linear model of the form: $log2(qij)=xj.βi$,
and $βi$ coefficients are computed. They give estimates of the log
fold changes for gene i for each column of the model matrix. Standard
errors for the log2 fold changes are also estimated.
