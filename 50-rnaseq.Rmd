...
the log2FC between conditions. $β_i$ coefficients are computed from the data.
...
The logFC are computed from the GLM, and these are associated to standard 
errors that depend on the variance of the counts.
...
into the calculation of FDR adjusted p-values.
...
5. Calculate the expression levels (in log2) of these 5 "best genes" 
