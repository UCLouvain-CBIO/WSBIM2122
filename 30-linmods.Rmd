...
where $y$ is the expression (the dependent or response variable) we
want to model and $x$ represents the two groups (the independent or
explanatory variable(s)) that are generally encoded as 0 and 1. The
expression above translates as follows:
