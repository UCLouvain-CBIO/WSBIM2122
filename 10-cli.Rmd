...
```{r prepare_shell_data, eval = FALSE}
...
- Start by creating a neww file that will contain the script, giving
  it the extension `.sh`.
...
```{r, echo=FALSE, fig.align='center', out.width='50%', fig.cap="The 10 slots defining the file permission (figure from the Data Carpentry's [*Working with Files and Directories*](https://datacarpentry.org/shell-genomics/03-working-with-files/) lesson."}
