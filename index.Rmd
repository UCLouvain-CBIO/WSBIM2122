...
Each project will entail an introductory session, dedicated office time
...
report. The report will contain an introduction, a description of the
experimental design of the data, a detailed description of the data
analysis steps, discussion and interpretation of the results,
including a biological interpretation, references and contribution
statement of all authors.

Tentative schedule for the course.

- CLI and Rmd
- Linear models and GSEA
- Project 1: HTS and RNA-Seq
- QA session for project 1
- Project 1 presentations
- Submission of the 1st report
- Project 2: MS and quantitative proteomcis
