...
files called fastq files.  For a single-read run, one fastq file is
...
[HISAT2](https://ccb.jhu.edu/software/hisat2/manual.shtml) aligner,
...
tuned (see the
[manual](https://ccb.jhu.edu/software/hisat2/manual.shtml) for more
