...
```{r}
counts_result <- read_tsv(file = "wsbim2122_data/count_data/sample1_counts.tsv")
...
Imagine you had initially 6 RNAseq samples (3 control and 3 treated samples) that you have 
...
```{r}
samples <- list.files("wsbim2122_data/count_data/", pattern = "*tsv")
